"use strict";
var precacheConfig = [
    ["/index.html", "96c51956f451d002912a4f23828a0129"],
    ["/static/js/main.3ac99c6f.js", "2399a632542a6c3b803b1c28bd4cd888"],
  ],
  cacheName =
  ...
  cleanResponse = function (e) {
    ...
    return ("body" in e ? Promise.resolve(e.body) : e.blob()).then(function (
      t
    ) {
